...
#input : a empty list
#output: a movie list
def init_my_favourite_movie(my_favourite_movie_list):
...
init_my_favourite_movie(my_favourite_movie_list)

#create a html to show movies
fresh_tomatoes.open_movies_page(init_my_favourite_movie(my_favourite_movie_list))
